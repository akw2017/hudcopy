...
{
  public partial class EddyCurrentTachometerChannelModelWrapper : ModelWrapper<EddyCurrentTachometerChannelModel>
  {
    public EddyCurrentTachometerChannelModelWrapper(EddyCurrentTachometerChannelModel model) : base(model)
    {
    }
    ...
    public System.Int32 ChannelType
    {
      get { return GetValue<System.Int32>(); }
      set { SetValue(value); }
    }

    public System.Int32 ChannelTypeOriginalValue => GetOriginalValue<System.Int32>(nameof(ChannelType));

    public bool ChannelTypeIsChanged => GetIsChanged(nameof(ChannelType));
    ...
    protected override void InitializeComplexProperties(EddyCurrentTachometerChannelModel model)
    {
