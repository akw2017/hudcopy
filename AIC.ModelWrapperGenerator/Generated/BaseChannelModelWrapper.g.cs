...
{
  public partial class BaseChannelModelWrapper : ModelWrapper<BaseChannelModel>
  {
    public BaseChannelModelWrapper(BaseChannelModel model) : base(model)
    {
    }
    ...
    protected override void InitializeComplexProperties(BaseChannelModel model)
    {
