...
namespace Kent.Boogaart.Truss
{
	...
	public class TypedBinding<TTarget, TSource> : SingleSourceBinding
	{
		...
		public TypedBinding(TTarget targetObject, Expression<Func<TTarget, object>> targetExpression, TSource sourceObject, Expression<Func<TSource, object>> sourceExpression)
		{
		...
		protected override PropertyExpression AttemptCreateSourcePropertyExpression()
		{
			...
			return LambdaPropertyExpression.FromLambdaExpression(sourceObject, _sourceExpression);
		}
	}
}