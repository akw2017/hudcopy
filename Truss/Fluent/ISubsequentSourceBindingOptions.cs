...
namespace Kent.Boogaart.Truss.Fluent
{
	...
	/// </summary>
	public interface ISubsequentSourceBindingOptions : IConverterSelection<ISubsequentSourceBindingOptions, IValueConverter>, IModeSelection<ISubsequentSourceBindingOptions>, IActivation, IHideObjectMembers
	{
		/// <summary>
