...
{
    public class PowerSpectrumDensityDataViewModel : HistoricalDataViewModel
    {
        ...
        public PowerSpectrumDensityDataViewModel()
        {
            DisplayMode = SignalDisplayType.PowerSpectrumDensity;
        }
