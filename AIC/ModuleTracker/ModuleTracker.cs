...
namespace AIC
{
    public class ModuleTracker : IModuleTracker
    {
        ...
        private readonly ModuleTrackingState moduleOnLineMonitorTrackingState;
        ...
        public ModuleTracker(ILoggerFacade logger)
        {
            ...
            this.moduleOnLineMonitorTrackingState = new ModuleTrackingState
            {
                ModuleName = WellKnownModuleNames.ModuleOnLineMonitor,
                ExpectedDiscoveryMethod = DiscoveryMethod.ApplicationReference,
                ExpectedInitializationMode = InitializationMode.OnDemand,
                ExpectedDownloadTiming = DownloadTiming.WithApplication,
                ConfiguredDependencies = WellKnownModuleNames.ModuleTreeService,
        ...
        public ModuleTrackingState ModuleOnLineMonitorTrackingState => moduleOnLineMonitorTrackingState;
        ...
        private ModuleTrackingState GetModuleTrackingState(string moduleName)
        {
            switch (moduleName)
            {
                ...
                case WellKnownModuleNames.ModuleOnLineMonitor:
                    return this.ModuleOnLineMonitorTrackingState;
                default:
                    return null;
            }
        }
