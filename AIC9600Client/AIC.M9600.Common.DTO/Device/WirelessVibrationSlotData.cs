...
{
    public class WirelessVibrationSlotData : D_WirelessVibrationSlot, ISlotData, ISlotWaveformData
    {
        ...
        public WirelessVibrationSlotData_DivFreInfo[] DivFreInfo { get; set; }

        [JsonIgnore]
        [WaveformType(Type = typeof(WirelessVibrationSlotData_Waveform))]
        public IWaveformData Waveform { get; set; }

        public IWaveformData GenerateWaveformData()
        {
            return new WirelessVibrationSlotData_Waveform();
        }
    }
}
