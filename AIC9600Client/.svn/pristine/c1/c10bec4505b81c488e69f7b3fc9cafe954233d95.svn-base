...
{
    public class EddyCurrentKeyPhaseSlotData : D_EddyCurrentKeyPhaseSlot, ISlotData, ISlotWaveformData
    {
        ...
        [JsonIgnore]
        [WaveformType(Type = typeof(EddyCurrentKeyPhaseSlotData_Waveform))]
        public IWaveformData Waveform { get; set; }

        public IWaveformData GenerateWaveformData()
        {
            return new EddyCurrentKeyPhaseSlotData_Waveform();
        }
    }
}
