...
{
    public class EddyCurrentTachometerCardViewModel : BindableBase, INavigationAware, IConfirmNavigationRequest
    {
        private readonly IPDAService _pdaService;
        public EddyCurrentTachometerCardViewModel(IPDAService pdaService)
        {
        ...
        private EddyCurrentTachometerCardWrapper card;
        public EddyCurrentTachometerCardWrapper Card
        {
            get { return card; }
            set
            {
        ...
        {
            var model = navigationContext.Parameters["Card"] as EddyCurrentTachometerCardModel;
            if (model != null)
            {
                if (Card == null || Card.Model != model)
                {
                    Card = new EddyCurrentTachometerCardWrapper(model);
                }
            }
            else
            {
