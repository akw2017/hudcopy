...
{
    public class EddyCurrentKeyPhaseCardViewModel : BindableBase, INavigationAware, IConfirmNavigationRequest
    {

        private readonly IPDAService _pdaService;
        public EddyCurrentKeyPhaseCardViewModel(IPDAService pdaService)
        {
        ...
        private EddyCurrentKeyPhaseCardWrapper card;
        public EddyCurrentKeyPhaseCardWrapper Card
        {
            get { return card; }
            set
            {
        ...
        {
            var model = navigationContext.Parameters["Card"] as EddyCurrentKeyPhaseCardModel;
            if (model != null)
            {
                if (Card == null || Card.Model != model)
                {
                    Card = new EddyCurrentKeyPhaseCardWrapper(model);
                }
            }
            else
            {
