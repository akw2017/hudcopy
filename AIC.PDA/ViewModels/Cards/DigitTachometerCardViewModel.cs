...
{
    public class DigitTachometerCardViewModel : BindableBase, INavigationAware, IConfirmNavigationRequest
    {
        private readonly IPDAService _pdaService;
        public DigitTachometerCardViewModel(IPDAService pdaService)
        {
        ...
        private DigitTachometerCardWrapper card;
        public DigitTachometerCardWrapper Card
        {
            get { return card; }
            set
            {
        ...
        {
            var model = navigationContext.Parameters["Card"] as DigitTachometerCardModel;
            if (model != null)
            {
                if (Card == null || Card.Model != model)
                {
                    Card = new DigitTachometerCardWrapper(model);
                }
            }
            else
            {
