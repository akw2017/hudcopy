...
{
    public class IEPEChannelViewModel:BindableBase,INavigationAware, IRegionManagerAware, IConfirmNavigationRequest
    {
        private readonly IPDAService _pdaService;
        public IEPEChannelViewModel(IPDAService pdaService)
        {
        ...
        private IEPEChannelWrapper channel;
        public IEPEChannelWrapper Channel
        {
            get { return channel; }
            set
            {
        ...
        {
            var model = navigationContext.Parameters["Channel"] as IEPEChannelModel;
            if (model != null)
            {
                if (Channel == null || Channel.Model != model)
                {
                    Channel = new IEPEChannelWrapper(model);
                }
            }
            else
            {
