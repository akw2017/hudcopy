...
{
    public class RelayChannelViewModel : BindableBase, INavigationAware, IConfirmNavigationRequest
    {

        private readonly IPDAService _pdaService;
        public RelayChannelViewModel(IPDAService pdaService)
        {
        ...
        private RelayChannelWrapper channel;
        public RelayChannelWrapper Channel
        {
            get { return channel; }
            set
            {
        ...
        {
            var model = navigationContext.Parameters["Channel"] as RelayChannelModel;
            if (model != null)
            {
                if (Channel == null || Channel.Model != model)
                {
                    Channel = new RelayChannelWrapper(model);
                }
            }
            else
            {
