...
{
    public class AnalogInChannelViewModel : BindableBase, INavigationAware, IConfirmNavigationRequest
    {

        private readonly IPDAService _pdaService;
        public AnalogInChannelViewModel(IPDAService pdaService)
        {
        ...
        private AnalogInChannelWrapper channel;
        public AnalogInChannelWrapper Channel
        {
            get { return channel; }
            set
            {
        ...
        {
            var model = navigationContext.Parameters["Channel"] as AnalogInChannelModel;
            if (model != null)
            {
                if (Channel == null || Channel.Model != model)
                {
                    Channel = new AnalogInChannelWrapper(model);  
                }
            }
            else
            {
