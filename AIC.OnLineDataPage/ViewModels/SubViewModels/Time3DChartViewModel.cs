...
{
    public class Time3DChartViewModel : ChartViewModelBase
    {
        public Time3DChartViewModel(BaseAlarmSignal signal)
            : base(signal)
        {
          
        }

        public Time3DChartViewModel(BaseAlarmSignal signal, bool isupdate) : this(signal)           
        {
            IsUpdated = isupdate;
        }
