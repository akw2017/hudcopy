...
#else
            PublicColor.FromRgb(187, 28, 0),
            PublicColor.FromRgb(222, 54, 11),
            PublicColor.FromRgb(199, 86, 10),
            PublicColor.FromRgb(255, 160, 0),
            PublicColor.FromRgb(255, 124, 0)
#endif
        };
...
#else
            chart.ChartBackground.Color = backgroundColor;
...
#else
                    chart.ChartBackground.Color = revertedChart.chartColor;
                    chart.ChartBackground.GradientFill = revertedChart.gradientChart;
#endif
...
#else
                chartColor = chart.ChartBackground.Color;
                gradientChart = chart.ChartBackground.GradientFill;
#endif
