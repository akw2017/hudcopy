...
{
    public class EddyCurrentTachometerSignalActor : ReceiveActor
    {
        private readonly EddyCurrentTachometerSignal _signal;
        public EddyCurrentTachometerSignalActor(EddyCurrentTachometerSignal signal)
        {
            _signal = signal;
            Context.SetReceiveTimeout(TimeSpan.FromSeconds(30));
            Receive<EddyCurrentTachometerChannelModel>(message => HandleDataContract(message));
        ...
        private void HandleDataContract(EddyCurrentTachometerChannelModel channel)
        {
            ...
            _signal.ChannelType = channel.ChannelType;
