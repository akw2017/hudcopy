...
namespace AIC.PDAPage.ViewModels
{
    ...
    {           
        ...
        public ExportDBDataViewModel(IOrganizationService organizationService, ICardProcess cardProcess, IDatabaseComponent databaseComponent, ILoginUserService loginUserService, IHardwareService hardwareService)
        {      
