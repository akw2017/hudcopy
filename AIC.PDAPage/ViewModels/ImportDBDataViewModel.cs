...
namespace AIC.PDAPage.ViewModels
{
    ...
    {           
        ...
        public ImportDBDataViewModel(IOrganizationService organizationService, ICardProcess cardProcess, IDatabaseComponent databaseComponent, ILocalConfiguration localConfiguration, IHardwareService hardwareService)
        {      
