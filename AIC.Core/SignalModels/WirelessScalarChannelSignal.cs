...
{
    public class WirelessScalarChannelSignal : BaseAlarmSignal
    {
        public WirelessScalarChannelSignal(Guid guid) : base(guid)
        {
        ...
        //public D_WirelessScalarSlot D_WirelessScalarSlot { get; set; }
    }
}
