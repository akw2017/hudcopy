...
{
    public class AnalogRransducerInChannelSignal : BaseAlarmSignal
    {
        public AnalogRransducerInChannelSignal(Guid guid) : base(guid)
        {
        ...
        //public D_AnalogRransducerInSlot D_AnalogRransducerInSlot { get; set; }
    }
}
