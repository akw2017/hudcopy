...
{
    public class DigitRransducerInChannelSignal : BaseAlarmSignal
    {
        public DigitRransducerInChannelSignal(Guid guid) : base(guid)
        {
        ...
        //public D_DigitRransducerInSlot D_DigitRransducerInSlot { get; set; }
    }
}
