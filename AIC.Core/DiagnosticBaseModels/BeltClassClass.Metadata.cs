...
{
    public partial class BeltClass : IDataErrorInfo
    {
        class BeltClassMetadata
        {
        ...
        public string Error
        {
            get
            {
                ...
                foreach (PropertyInfo pinfo in propertys)
                {
                    ...
                    {
                        error = this.ValidateProperty<BeltClassMetadata>(pinfo.Name);
        ...
        public string this[string columnName]
        {
            get
            {
                return this.ValidateProperty<BeltClassMetadata>(columnName);
            }
        }
    }
}
