...
{
    public partial class GearClass : IDataErrorInfo
    {
        class GearClassMetadata
        {
        ...
        public string Error
        {
            get
            {
                ...
                foreach (PropertyInfo pinfo in propertys)
                {
                    ...
                    {
                        error = this.ValidateProperty<GearClassMetadata>(pinfo.Name);
        ...
        public string this[string columnName]
        {
            get
            {
                return this.ValidateProperty<GearClassMetadata>(columnName);
            }
        }
    }
}
