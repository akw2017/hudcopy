...
namespace AIC.Core
{
    ...
    {
        private static readonly VisibilityToBoolConverter defaultInstance = new VisibilityToBoolConverter();


        /// <summary>
        /// Gets the default instance of this converter.
        /// </summary>
        public static VisibilityToBoolConverter Default { get { return defaultInstance; } }
