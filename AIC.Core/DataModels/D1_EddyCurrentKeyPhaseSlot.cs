...
{
    public class D1_EddyCurrentKeyPhaseSlot : EddyCurrentKeyPhaseSlotData, IBaseWaveSlot//电涡流键相表
    {
    ...
    //    public int AverageNumber { get; set; } //平均次数
    //    public float CalibrationCor { get; set; } //校准系数
    //    public int EddyCurrentRPMCode { get; set; } //采样代码
    //    public float HysteresisVolt { get; set; } //迟滞电压
    //    public bool IsNotch { get; set; } //凹槽还是凸槽
    //    public float TeethNumber { get; set; } //齿数
