    ...
    public class ItemsControlDragDropBehavior : Behavior<ItemsControl>
{
        ...
        protected override void OnAttached()
        {
            ...
            this.AssociatedObject.PreviewDragLeave += new DragEventHandler(itemsControl_DragLeave);
        }
        ...
        void itemsControl_PreviewDrop(object sender, DragEventArgs e)
        {
            ...
            var dragSource = e.Data.GetData("DropTarget");
            if (dragSource != null && dragSource.ToString() == "ContentControlDragDropBehavior")
            {
                e.Data.SetData("DropTarget", "ItemsControlDragDropBehavior");
            }
        }
